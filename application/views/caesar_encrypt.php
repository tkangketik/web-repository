        ...
        <div class='col-xs-12'>
            <div class='box'>
                <div class='box-header'>
                    <h3 class='box-title'>Enkripsi Pesan</h3>
                    <div class='box box-primary'>
                        <form action="" method="post">
                            <table class='table table-bordered'>
                                <tr>
                                    <td>Kunci </td>
                                    <td><input type="text" class="form-control" name="kunci" required />
                                    </td>
                                </tr>
                                <tr>
                                    <td>Pesan</td>
                                ...
                                <tr>
                                    <td colspan='2'><button type="submit" name="klik" class="btn btn-primary">Enkripsi</button>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if (isset($_POST['klik'])) {
                                        ...
                                        <a class="btn btn-default" href="<?= base_url()?>enkripsi/create/?hasil=<?php echo $cipherText = Encipher($chiperkeyText, 3); ?>&kunci=<?php echo $kunci; ?>"><i class="fa fa-plus"></i>&nbsp;Simpan Data</a>
                                    <?php } else { ?>
                                        <p style="padding:0px; margin:0 auto;">
                                            Menunggu Proses Masukan..</p>
                                    <?php }; ?>
