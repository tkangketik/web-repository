...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url() ?>"><b>Selamat Datang </b> Website Repository Foto</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <?php if (isset($_GET['gagal'])) { ?>
                <div class='alert alert-danger' style='margin: 10px'>
                    <center>Username sudah dipakai</center>
                </div>
            <?php } ?>
            <form action="<?= current_url(); ?>/create_action" method="post">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <button type="submit" name="submit" id="btnSubmit" class="btn btn-primary btn-block btn-flat">Register</button>
                    </div>
                </div>
            </form>
            <br>
            <center>Sudah punya akun? <a class="btn btn-default " href="<?= base_url() ?>auth/login"> <span>Login</span></a></li>
            </center>
